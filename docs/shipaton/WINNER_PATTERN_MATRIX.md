...
## 5. What the winning videos do in their first two minutes (auto captions fetched 2026-09-03; visuals not verified)

Sources: YouTube auto captions via yt_dlp for Gurwi (3:28), Heartbeat Hero (15:11, front-loaded), Flowmino (3:26), ReadHim (3:04), Vector Guard (3:20). Karo (0:48) and Dayloop (2:54) have music only, no narration. Meshing had no captions; Payout's video was unavailable. Quotes are from the captions.

| Second | What happens in the narrated winners |
|---|---|
| 0 to 5 | The maker speaks, first person, name and role: "I'm Camilo. I'm from Colombia", "Hello, my name is Aiden Forest and I'm the creator of Heartbeat Hero", "hi I'm RF I'm Flo we're two procrastinators", "Hi judges, I'm Jay", "I'm Ellie, a PhD student at UC San Diego". |
| 5 to 20 | One sentence of what the app is, in plain words: "the visual interactive and multilingual learning app to learn about anything"; "allows anybody to not only learn CPR, but also physically practice it without any extra equipment"; "an IOS app to help people like us manage our time and protect our attention". Vector Guard spends the first 20 seconds on the problem ("information primarily stays in academic papers") before "So, I built Vector Guard". |
| 15 to 30 | The app in use on the device, narrated as a real session: "let me show you so right now it's noon and my current activity is..." (Flowmino), "So let's begin with the rhythm practice. Now when I tap into here..." (Heartbeat Hero), "When you open KI, you can choose any of its classes..." (Gurwi). |
| 20 to 45 | The category or the contest named out loud when it is a growth or buzz award: "to definitively win the buzziest launch award" (ReadHim, 15 s), "my 2025 ship entry" (Heartbeat Hero). Growth numbers spoken early: "within just 10 days post launch, we generated nearly 6 million organic views ... and crossed over $1,000 in monthly recurring revenue" (ReadHim, 30 to 45 s). |
| 45 to 120 | One feature at a time, each with a sentence of why it matters, and the distinctive mechanism called out by name: "my favorite feature of the whole of Heartbeat Hero and the most innovative feature in my opinion is the depth practice ... down to the millimeter" (90 s); "The map is where science becomes accessible. CDC data exists in complex spreadsheets and PDFs, but we can transform it into this" (Vector Guard, 35 s); Gurwi shows the authoring tool behind the app at 75 s ("the software where we manage the app"). |
| RevenueCat | Named in the first two minutes only by ReadHim ("RevenueCat made it so easy and fast for us to set up the paywall and monetize the app through a subscription", about 80 s). The others do not say the word in their opening two minutes. The 2026 Next Gen criteria ask for it, so Konvo should. |
| Failure | ReadHim: "after four rejections back and forth with Apple" at about 95 s. Flowmino hands to the co-founder at 120 s for the blocking part: "it's not planning for the future it's doing things in the present". |
| Music only | Karo (48 s) and Dayloop won Design and Most Likely to Make Money with no narration at all; their videos carry on-screen text over the app (not verifiable from captions). |

Pattern for Konvo's video, derived: speak first, name yourself and say "Next Gen" in the first fifteen seconds, one plain sentence of what it is, then a real session on the phone narrated in the present tense, the purchase by 40 s (no winner showed a purchase this early, but the 2026 guide and criteria demand it), the mechanism named ("five rules, 39 selectors, a patch live in a minute"), one failure closed with its fix, numbers with dates, and no music bed under the voice. Under two minutes, since 2026 screeners stop there and the rule says less than two.
