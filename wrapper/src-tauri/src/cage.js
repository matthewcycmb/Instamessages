...
(function () {
  ...
  if (/iPhone|iPad|iPod/.test(navigator.userAgent)) (function () {
    ...
    function proofBlock() {
      return "<div class='imp-proof' style='position:relative;width:290px;margin:6px auto 12px'>" +
    ...
    function impactPage() {
      ...
      return "<div class='imp-head' style='height:112px'>" +
        ...
        "<div style='flex:1;min-height:12px'></div>" + proofBlock() +
        "<div style='flex:1.6;min-height:24px'></div></div>" +
        "<div class='imp-foot'>" +
